        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-18 mb-4 order-0">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Shelf 13 List</h3>
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 400px;">
                      <form action="/searchShelf13" method="get">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <?php
                        $recordsPerPage1 = 5;
                        $totalPages1 = ceil(count($shelf13) / $recordsPerPage1);
                        $currentPage1 = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
                        $offset1 = ($currentPage1 - 1) * $recordsPerPage1;
                        $subset1 = array_slice($shelf13, $offset1, $recordsPerPage1);
                        $x = 1;
            ...
            <div class="col-lg-18 mb-4 order-0">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Shelf 14 List</h3>
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 400px;">
                      <form action="/searchShelf14" method="get">
                        <div class="input-group-append">
                        <input type="text" name="search" class="form-control float-right me-2" placeholder="Search">
                        <select class="form-control" name="categ">
                            <option value="book_title">Book Title</option>
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <?php
                        $recordsPerPage = 5;
                        $totalPages = ceil(count($shelf14) / $recordsPerPage);
                        $currentPage = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
                        $offset = ($currentPage - 1) * $recordsPerPage;
                        $subset = array_slice($shelf14, $offset, $recordsPerPage);
                        $a = 1;
