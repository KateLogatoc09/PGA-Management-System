        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-18 mb-4 order-0">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Shelf 4 List</h3>
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 400px;">
                      <form action="/searchShelf4" method="get">
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <?php
                        $recordsPerPage1 = 5;
                        $totalPages1 = ceil(count($shelf4) / $recordsPerPage1);
                        $currentPage1 = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
                        $offset1 = ($currentPage1 - 1) * $recordsPerPage1;
                        $subset1 = array_slice($shelf4, $offset1, $recordsPerPage1);
                        $x = 1;
            ...
            <div class="col-lg-18 mb-4 order-0">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Shelf 10 List</h3>
                    <div class="card-tools">
                      <div class="input-group input-group-sm" style="width: 400px;">
                      <form action="/searchShelf10" method="get">
                        <div class="input-group-append">
                        <input type="text" name="search" class="form-control float-right" placeholder="Search">
                          <button type="submit" class="btn btn-default">
                          <i class="menu-icon tf-icons bx bx-search"></i>
                  ...
                  <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        <?php
                        $recordsPerPage = 5;
                        $totalPages = ceil(count($shelf10) / $recordsPerPage);
                        $currentPage = isset($_GET['page']) ? max(1, intval($_GET['page'])) : 1;
                        $offset = ($currentPage - 1) * $recordsPerPage;
                        $subset = array_slice($shelf10, $offset, $recordsPerPage);
                        $a = 1;
