                            ...
                            <thead>
                                ...
                                <?php $x = 1; foreach ($subjectSubset as $ad): ?>
                                    <tr>
                                            ...
                                            <td> <a href="/aacdeleteSubject/<?php echo bin2hex($encrypter->encrypt($ad['id'])); ?>" class="btn btn-danger btn-sm" id="d<?=$x?>">Delete</a>
                                            <a href="/aaceditSubject/<?php echo bin2hex($encrypter->encrypt($ad['id'])); ?>" class="btn btn-primary btn-sm">Edit</a></td>
                                     </tr>
                                <?php $x++; endforeach ?>
                                </tbody>
                            </table>
