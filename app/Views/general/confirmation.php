                  ...
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-20">
                      <div class="card-body">
                        ...
                        <p class="mb-10 center">Thank You for applying for an account. Please wait until the application is verified. 
                          You will receive an email regarding the result.</p>
                          <a href="/general" class="btn btn-primary sub">Ok</a>
                      </div>
