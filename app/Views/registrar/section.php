                      ...
                      <tbody>
                        <?php $x = 1; foreach ($sectionSubset as $ad): ?>
                          ...
                          <td><?= $ad['name'] ?></td>
                            ...
                            <td> <a href="/deleteSection/<?php echo bin2hex($encrypter->encrypt($ad['id'])); ?>" class="btn btn-danger btn-sm" id="d<?=$x?>">Delete</a>
                              <a href="/editSection/<?php echo bin2hex($encrypter->encrypt($ad['id'])); ?>" class="btn btn-primary btn-sm" >Edit</a></td>
                          </tr>
                        <?php $x++; endforeach ?>
                      </tbody>
                    </table>
